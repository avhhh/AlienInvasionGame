...
Alien.o: Alien.cpp Alien.h Game_Object.h Person.h Cart_Vector.h Cart_Point.h
	$(CC) -c Alien.cpp -o Alien.o

main.o: main.cpp Cart_Point.h Cart_Vector.h Game_Command.h Oxygen_Depot.h Astronaut.h Model.h Person.h Alien.h Space_Station.h Game_Object.h View.h Input_Handling.h
	$(CC) -c main.cpp
